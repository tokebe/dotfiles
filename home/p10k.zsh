# Generated by Powerlevel10k configuration wizard on 2023-09-13 at 13:26 EDT.
...
# no frame, compact, many icons, concise, transient_prompt, instant_prompt=auto-quiet.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%6F'  # grey foreground
      local      clean='%6F'  # grey foreground
      local   modified='%6F'  # grey foreground
      local  untracked='%6F'  # grey foreground
      local conflicted='%6F'  # grey foreground
    fi
